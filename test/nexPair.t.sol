...
contract NexPairTest is Test {
    ...
    function setUp() public {
        ...
        nexFactory factory = new nexFactory();
...
contract TestUser {
    function provideLiquidity(
        ...
        nexPair(pairAddress_).mint(address(this));
    }
    ...
    function removeLiquidity(address pairAddress_) public {
        ...
        nexPair(pairAddress_).burn(address(this));
    }
}
